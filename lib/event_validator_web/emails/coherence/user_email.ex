...
defmodule EventValidatorWeb.Coherence.UserEmail do
  @moduledoc """
  ...
  * Account Unlock
  ...
  """
  use Phoenix.Swoosh,
    view: EventValidatorWeb.Coherence.EmailView,
    layout: {EventValidatorWeb.Coherence.LayoutView, :email}
